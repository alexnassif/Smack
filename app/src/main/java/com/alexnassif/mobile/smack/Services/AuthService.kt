package com.alexnassif.mobile.smack.Services

import android.content.Context
import android.util.Log
import com.alexnassif.mobile.smack.Utilities.URL_CREATE_USER
import com.alexnassif.mobile.smack.Utilities.URL_LOGIN
import com.alexnassif.mobile.smack.Utilities.URL_REGISTER
...
/**
 * Created by alexnassif on 11/30/17.
 */
object AuthService {
    ...
    fun createUser(context: Context, name: String, email: String, avatarName: String,
        ...
        val createRequest = object : JsonObjectRequest(Method.POST, URL_CREATE_USER,
